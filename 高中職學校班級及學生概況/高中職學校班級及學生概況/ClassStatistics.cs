...
namespace 高中職學校班級及學生概況
{
    public class ClassStatistics
    {
        ...
        public void StartStatistics(int type, List<string> DeptNameList)
        {
            ...
            try
            {
                foreach (ClassRecord ClassRec in Classes)
                {
                    ...
                    {
                        if (DeptNameList.Contains(ClassRec.Department))
                        {
                            if (type == 0)
                            ...
                            if (type == 1)
                            {
                                if (!ClassRec.Department.Contains("普通科") && !ClassRec.Department.Contains("綜合高中"))
                                    pass1 = true;
                            }

                            if (type == 2)
                            {
                                if (ClassRec.Department.Contains("綜合高中"))
                                    pass1 = true;
                            }
                        }                       
                    }
                    ...
                    {
                        bool pass2 = false;
                        if (DeptNameList.Contains(Student.Department))
                        {
                            if (!string.IsNullOrEmpty(Student.Department))
                            {
                                ...
                                if (type == 1)
                                {
                                    if (!Student.Department.Contains("普通科") && !Student.Department.Contains("綜合高中"))
                                        pass2 = true;
                                }

                                if (type == 2)
                                {
                                    if (Student.Department.Contains("綜合高中"))
                                        pass2 = true;
                                }
                            }
